<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="categoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" align="center" width="55" prop="categoryId" type="index"/>
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除社团分类管理编号为"' + _categoryIds + '"的数据项？').then(function() {
