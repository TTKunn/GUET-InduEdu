  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="所属社团" prop="clubId">
        <el-input v-model="queryParams.clubName" placeholder="请输入所属社团名称" clearable @keyup.enter="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="warning" plain icon="Download" @click="handleExport"
          v-hasPermi="['manage:attendance:export']">导出</el-button>
      </el-col>
    ...
    <el-dialog title="考勤详情" v-model="detailOpen" width="600px" append-to-body>
      <el-descriptions :column="1" border>
        <el-descriptions-item label="序号">{{ detailData.attendanceId }}</el-descriptions-item>
        <el-descriptions-item label="所属社团">{{ detailData.clubName }}</el-descriptions-item>
        <el-descriptions-item label="成员">{{ detailData.userName }}</el-descriptions-item>
...
import { listAttendance, getAttendance, delAttendance, addAttendance, updateAttendance } from "@/api/manage/attendance";
...
const detailOpen = ref(false); // Add detail dialog state
const detailData = ref({}); // Add detail data
...
function getList() {
  ...
  if (null != daterangeClockInTime && '' != daterangeClockInTime) {
  ...
  if (null != daterangeClockOutTime && '' != daterangeClockOutTime) {
...
function handleExport() {
  proxy.download('manage/attendance/export', {
    ...queryParams.value
